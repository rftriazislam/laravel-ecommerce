...
<!--[if (gt IE 9)|!(IE)]><!--><html lang="en"><!--<![endif]-->
    ...
    <head>
        ...
        <link rel="icon" type="{{asset('master_style/image')}}/ico" href="{{asset('master_style/images')}}/fav.ico">
        <!--stylesheet include-->
        <link rel="stylesheet" type="text/css" media="all" href="{{asset('master_style/css')}}/colorpicker.css">
        <link rel="stylesheet" type="text/css" media="all" href="{{asset('master_style/css')}}/flexslider.css">
        <link rel="stylesheet" type="text/css" media="all" href="{{asset('master_style/css')}}/bootstrap.min.css">
        <link rel="stylesheet" type="text/css" media="all" href="{{asset('master_style/css')}}/owl.carousel.css">
        <link rel="stylesheet" type="text/css" media="all" href="{{asset('master_style/css')}}/owl.transitions.css">
        <link rel="stylesheet" type="text/css" media="all" href="{{asset('master_style/css')}}/jquery.custom-scrollbar.css">
        <link rel="stylesheet" type="text/css" media="all" href="{{asset('master_style/css')}}/style.css">
        <!--font include-->
        <link href="{{asset('master_style/css')}}/font-awesome.min.css" rel="stylesheet">
    ...
    <body>
        ...
        <div class="wide_layout relative w_xs_auto">
                    ...
                    <div class="clearfix row">
                        <div class="col-lg-6 col-md-6 col-sm-4 t_xs_align_c">
                            <a href="index-2.html" class="logo m_xs_bottom_15 d_xs_inline_b">
                               <h3>Book Mension & Varites Shop</h3>
                            </a>
                        </div>
                            ...
                            <div class="row clearfix">
                                <div class="col-lg-6 col-md-6 col-sm-6 t_align_r t_xs_align_c m_xs_bottom_15">
                                    <dl class="l_height_medium">
                                        ...
                                        <dd class="f_size_ex_large color_dark">01766666666666</dd>
                                    </dl>
                                </div>
                    ...
                    <section class="menu_wrap type_2 relative clearfix t_xs_align_c m_bottom_20">
                        ...
                        <nav role="navigation" class="f_left f_xs_none d_xs_none t_xs_align_l">	
                            <ul class="horizontal_list main_menu clearfix">
                                ...
                                <li class="relative f_xs_none m_xs_bottom_5"><a href="{{'pages'}}" class="tr_delay_hover color_light tt_uppercase"><b>Khata</b></a>

                                </li>
                                <li class="relative f_xs_none m_xs_bottom_5"><a href="blog.html" class="tr_delay_hover color_light tt_uppercase"><b>Pen</b></a>
                                    <!--sub menu-->
                                ...
                                <li class="relative f_xs_none m_xs_bottom_5"><a href="blog.html" class="tr_delay_hover color_light tt_uppercase"><b>Shapner</b></a>
                                    <!--sub menu-->
                                    <div class="sub_menu_wrap top_arrow d_xs_none type_2 tr_all_hover clearfix r_corners">
                                        <ul class="sub_menu">
                                            <li><a class="color_dark tr_delay_hover" href="features_shortcodes.html">Shortcodes</a></li>
                                ...
                                <li class="relative f_xs_none m_xs_bottom_5"><a href="{{'contract'}}" class="tr_delay_hover color_light tt_uppercase"><b>Contact</b></a></li>
                            </ul>
                        </nav>
                                ...
                                <div class="shopping_cart top_arrow tr_all_hover r_corners">
                                    ...
                                    <ul class="products_list">
                                        <li>
                                            <div class="clearfix">
                                                <!--product image-->
                                                <img class="f_left m_right_10" src="{{asset('master_style/images')}}/shopping_c_img_1.jpg" alt="">
                                                <!--product description-->
                                        ...
                                        <li>
                                            <div class="clearfix">
                                                <!--product image-->
                                                <img class="f_left m_right_10" src="{{asset('master_style/images')}}/shopping_c_img_2.jpg" alt="">
                                                <!--product description-->
                                                <div class="f_left product_description">
                                                    <a href="#" class="color_dark m_bottom_5 d_block">Cursus eleifend elit aenean auctor wisi et urna</a>
                                                    <span class="f_size_medium">Product Code PS34</span>
                                        ...
                                        <li>
                                            <div class="clearfix">
                                                <!--product image-->
                                                <img class="f_left m_right_10" src="{{asset('master_style/images')}}/shopping_c_img_3.jpg" alt="">
                                                <!--product description-->
                                                <div class="f_left product_description">
                                                    <a href="#" class="color_dark m_bottom_5 d_block">Cursus eleifend elit aenean auctor wisi et urna</a>
                                                    <span class="f_size_medium">Product Code PS34</span>
            ...
            <footer id="footer" class="type_2">
                ...
                <div class="footer_bottom_part">
                    <div class="container clearfix t_mxs_align_c">
                        ...
                        <ul class="f_right horizontal_list clearfix f_mxs_none d_mxs_inline_b">
                            <li><img src="{{asset('master_style/images')}}/payment_img_1.png" alt=""></li>
                            <li class="m_left_5"><img src="{{asset('master_style/images')}}/payment_img_2.png" alt=""></li>
                            <li class="m_left_5"><img src="{{asset('master_style/images')}}/payment_img_3.png" alt=""></li>
                            <li class="m_left_5"><img src="{{asset('master_style/images')}}/payment_img_4.png" alt=""></li>
                            <li class="m_left_5"><img src="{{asset('master_style/images')}}/payment_img_5.png" alt=""></li>
                        </ul>
                    </div>
                </div>
                <!-- bottom menu -->
                <div class="container">
                    ...
                    <section class="menu_bottom bm-3 relative clearfix  t_xs_align_c m_bm_20 stick">
                    
                    <ul class="horizontal_list bm-cl main_menu clearfix" >
                                <li class="bm-li"><a href="{{'category'}}" ><b><i class="fa fa-list hi"></i></b></a>
                                    <!--sub menu-->

                                </li>

                                <li class="bm-li"><a href="{{'/'}}"><b><i class="fa fa-home hi"></i></b></a>

                                </li>
                                <li class="bm-li"><a href="A"><b><i class="fa fa-undo hi"></i></b></a>
                                    <!--sub menu-->
                    ...
                    <div class="custom_scrollbar">
                        ...
                        <div class="f_left half_column">
                            <div class="relative d_inline_b m_bottom_10 qv_preview">
                                ...
                                <img src="{{asset('master_style/images')}}/quick_view_img_1.jpg" class="tr_all_hover" alt="">
                            </div>
                            <!--carousel-->
                            <div class="relative qv_carousel_wrap m_bottom_20">
                                ...
                                <ul class="qv_carousel d_inline_middle">
                                    <li data-src="{{asset('master_style/images')}}/quick_view_img_1.jpg"><img src="{{asset('master_style/images')}}/quick_view_img_4.jpg" alt=""></li>
                                    <li data-src="{{asset('master_style/images')}}/quick_view_img_2.jpg"><img src="{{asset('master_style/images')}}/quick_view_img_5.jpg" alt=""></li>
                                    <li data-src="{{asset('master_style/images')}}/quick_view_img_3.jpg"><img src="{{asset('master_style/images')}}/quick_view_img_6.jpg" alt=""></li>
                                    <li data-src="{{asset('master_style/images')}}/quick_view_img_1.jpg"><img src="{{asset('master_style/images')}}/quick_view_img_4.jpg" alt=""></li>
                                    <li data-src="{{asset('master_style/images')}}/quick_view_img_2.jpg"><img src="{{asset('master_style/images')}}/quick_view_img_5.jpg" alt=""></li>
                                    <li data-src="{{asset('master_style/images')}}/quick_view_img_3.jpg"><img src="{{asset('master_style/images')}}/quick_view_img_6.jpg" alt=""></li>
                                </ul>
        ...
        <!--scripts include-->
        <script src="{{asset('master_style/js')}}/jquery-2.1.0.min.js"></script>
        <script src="{{asset('master_style/js')}}/retina.js"></script>
        <script src="{{asset('master_style/js')}}/jquery.flexslider-min.js"></script>
        <script src="{{asset('master_style/js')}}/styleswitcher.js"></script>
        <script src="{{asset('master_style/js')}}/colorpicker.js"></script>
        <script src="{{asset('master_style/js')}}/waypoints.min.js"></script>
        <script src="{{asset('master_style/js')}}/jquery.isotope.min.js"></script>
        <script src="{{asset('master_style/js')}}/owl.carousel.min.js"></script>
        <script src="{{asset('master_style/js')}}/jquery.tweet.min.js"></script>
        <script src="{{asset('master_style/js')}}/jquery.custom-scrollbar.js"></script>
        <script src="{{asset('master_style/js')}}/scripts.js"></script>
        <script type="text/javascript" src="../../s7.addthis.com/{{asset('master_style/js')}}/300/addthis_widget.js#pubid=xa-5306f8f674bfda4c"></script>
    </body>
